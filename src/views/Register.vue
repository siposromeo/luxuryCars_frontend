<template>
  <form class="position-absolute top-50 start-50 translate-middle" style="text-align: center; margin-top: 3rem;">
    ...
    <div>
      <label for="emailInput" class="form-label" style="color: orange; margin-bottom: 0.5rem; margin-top: 0.5rem;">Email cím</label>
      <input type="email" class="form-control" id="emailInput">
    </div>
    <div>
      <label for="inputPassword" class="form-label" style="font-weight: bolder; color: orange; margin-bottom: 0.5rem; margin-top: 0.5rem;">Jelszó</label>
      <input type="password" id="inputPassword" class="form-control">
    </div>
    <div>
      <label for="inputPasswordAgain" class="form-label" style="color: orange; margin-bottom: 0.5rem; margin-top: 0.5rem;">Jelszó újra</label>
